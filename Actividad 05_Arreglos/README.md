# Arreglos
## Descripción
Programas en C que practican el uso de arreglos para
almacenar y manipular colecciones de datos del mismo tipo.

## Temas aplicados

- Declaración e inicialización de arreglos
- Acceso a elementos de un arreglo por índice
- Arreglos de tamaño dinámico, ingresador por el usuario
...
## Compilación
```bash
gcc direcciones_arreglo_temperaturas.c -o direcciones_arreglo_temperaturas
gcc valores_arreglo.c -o valores_arreglo
```

## Ejecución
```bash
./direcciones_arreglo_temperaturas
./valores_arreglo
```
