...
int main()
{
    ...
    int valor, contador_elementos=0, opcion, contador_elementos1=0;

    capturar(arreglo, n);
    mostar (arreglo, n);
    do
    {
        printf ("\n---Menu para filtrar arreglos---\n");
        printf ("\n 1.Filtrar numeros impares");
        printf ("\n 2.Filtrar multiplos de 3");
        printf ("\n 3.Filtrar numeros mayores a 10");
        printf ("\n 4.Salir");
